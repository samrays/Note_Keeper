...
import com.example.sam.notekeeper.NoteKeeperDatabaseContract.CourseInfoEntry;
...
//            ourInstance.initializeExampleNotes();
    ...
    public static void loadFromDatabase(NoteKeeperOpenHelper dbHelper){
        ...
        final Cursor courseCursor = db.query(
                CourseInfoEntry.TABLE_NAME, courseColumns, null, null,
                null, null, CourseInfoEntry.COLUMN_COURSE_TITLE + " DESC");
